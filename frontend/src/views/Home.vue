    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              단 하나의 문장만으로도, <span class=”highlight-bold”>MiroFish</span>는 그 안의 현실 시드를 기반으로 최대 <span class=”highlight-orange”>백만 Agent</span>로 구성된 평행 세계를 완전 자동으로 생성합니다. 신의 시점에서 변수를 주입하여 복잡한 집단 상호작용 속에서 동적 환경의 <span class=”highlight-code”>”국소 최적해”</span>를 탐색합니다
            </p>
            <p class="slogan-text">
              미래를 Agent 군집에서 미리 시연하고, 결정을 백전 끝에 승리로 이끌다<span class="blinking-cursor">_</span>
            </p>
          </div>
            ...
            <div class="workflow-list">
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">현실 시드 추출 & 개인 및 집단 기억 주입 & GraphRAG 구축</div>
                </div>
              </div>
              <div class="workflow-item">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">ReportAgent가 풍부한 도구로 시뮬레이션 후 환경과 심층 상호작용</div>
                </div>
              </div>
              <div class="workflow-item">
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// 자연어로 시뮬레이션 또는 예측 요구사항을 입력하세요 (예: 특정 기업이 신제품 출시를 발표하면 여론이 어떻게 흘러갈까?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
