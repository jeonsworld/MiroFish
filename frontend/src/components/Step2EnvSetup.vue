    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': phase === 0, 'completed': phase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            시뮬레이션 인스턴스를 생성하고 시뮬레이션 세계 파라미터 템플릿을 가져옵니다
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            LLM이 시뮬레이션 요구사항과 현실 시드를 기반으로 세계 시간 흐름, 추천 알고리즘, 각 개체의 활동 시간대, 발언 빈도, 이벤트 트리거 등의 파라미터를 지능적으로 설정합니다
          </p>
                  ...
                  <div class="agent-params">
                    <div class="param-group">
                      <div class="param-item">
                        <span class="param-label">포스트/시간</span>
              ...
              <div v-if="useCustomRounds" class="rounds-content custom" key="custom">
                <div class="slider-display">
                  ...
                  <div class="slider-meta-info">
                    <span>Agent 규모 100 기준: 예상 소요 시간 약 {{ Math.round(customMaxRounds * 0.6) }} 분</span>
                  </div>
                </div>
                  ...
                  <div class="auto-content">
                    <div class="auto-meta-row">
                      <span class="duration-badge">
                        ...
                        Agent 규모 100 기준: 예상 소요 시간 {{ Math.round(autoGeneratedRounds * 0.6) }} 분
                      </span>
                    </div>
                    <div class="auto-desc">
                      <p class="highlight-tip" @click="useCustomRounds = true">처음 실행하는 경우, ‘사용자 정의 모드’로 전환하여 시뮬레이션 라운드 수를 줄이면 빠르게 결과를 미리보고 오류 위험을 낮출 수 있습니다 ➝</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="modal-section" v-if="selectedProfile.persona">
            ...
            <div class="persona-dimensions">
              ...
              <div class="dimension-card">
                ...
                <span class="dim-desc">개체 연결과 인터랙션 그래프</span>
              </div>
            </div>
    ...
    if (res.success && res.data) {
      ...
      if (data.config_generated && data.config) {
        ...
        if (data.config.time_config) {
          ...
          addLog(`时间配置: 每轮${tc.minutes_per_round}분, 共${Math.floor((tc.total_simulation_hours * 60) / tc.minutes_per_round)}轮`)
        }
