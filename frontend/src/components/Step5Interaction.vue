          ...
          <div class="action-bar-tabs">
            ...
            <div class="agent-dropdown" v-if="profiles.length > 0">
              ...
              >
                ...
                <span>{{ selectedAgent ? selectedAgent.username : '세계 속 누구와도 대화' }}</span>
        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">리포트 생성 에이전트의 빠른 대화 버전으로, 4종의 전문 도구를 호출할 수 있으며 MiroFish의 완전한 기억을 보유합니다</div>
              </div>
              ...
              <div class="tools-grid">
                ...
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">그래프 구조 기반 너비 우선 탐색 알고리즘으로 이벤트 전파 경로를 재구성하고, 전체 정보 흐름의 토폴로지를 캡처합니다</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">GraphRAG 기반 즉시 쿼리 인터페이스로 인덱싱 효율을 최적화하여 특정 노드 속성과 개별 사실을 빠르게 추출합니다</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">자율적 인터뷰로 시뮬레이션 세계의 개체들과 병렬로 다회 대화를 진행하여 비정형 관점 데이터와 심리 상태를 수집합니다</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Report Agent와 대화하여 리포트 내용을 깊이 이해하세요' : '시뮬레이션 개체와 대화하여 그들의 관점을 파악하세요' }}
              </p>
            </div>
            <div 
