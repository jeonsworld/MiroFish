...
- Agent behaviors and speech in the simulation world are predictions of future human behavior
...
3. [Language Consistency - Quoted Content Must Be Translated to Report Language]
   ...
   - When quoting tool-returned content in a different language, you must translate it into the report language before writing
   - Maintain the original meaning during translation, ensuring natural and fluent expression
   - This rule applies to both body text and quoted blocks (> format)

4. [Faithfully Present Prediction Results]
   - Report content must reflect simulation results from the simulation world representing the future
...
- Do NOT add section titles at the beginning of content
...
[Correct Example]
```
This section analyzes the public opinion dynamics. Through in-depth analysis of simulation data, we found...

**Initial Explosion Phase**

The platform served as the primary venue for breaking news:

> "The platform contributed 68% of initial discourse volume..."
        ...
        for iteration in range(max_iterations):
            if progress_callback:
                progress_callback(
                    ...
                    f"Researching and writing ({tool_calls_count}/{self.MAX_TOOL_CALLS_PER_SECTION})"
                )
